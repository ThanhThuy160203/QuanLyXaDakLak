...
export const ChairmanTaskListScreen = () => {
	...
	return (
		<ScrollView contentContainerStyle={styles.screen}>
			<Text style={styles.title}>Danh sách nhiệm vụ cấp {roleLabel.toLowerCase()}</Text>
			<Text style={styles.subtitle}>Ưu tiên hiển thị các nguồn giao từ Luật định hoặc khẩn.</Text>
