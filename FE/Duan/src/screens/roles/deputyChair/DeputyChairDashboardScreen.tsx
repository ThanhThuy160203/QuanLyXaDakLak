...
export const DeputyChairDashboardScreen = () => {
  ...
  const quickActions = [
    {
      key: 'directive',
      title: 'Gửi chỉ đạo',
      subtitle: 'Chia sẻ báo cáo nhanh cho phòng ban',
      accent: true,
    ...
    },
    {
      ...
      subtitle: 'Lấy tiến độ mới nhất từ đơn vị',
      accent: false,
      onPress: () => fetchTasks({ force: true }),
    },
  ];

  const insights = departmentRankings.length ? (
  ...
  return (
    <ScrollView contentContainerStyle={styles.screen}>
      <Text style={styles.greeting}>Xin chào, {user?.displayName || 'Phó Chủ tịch'}</Text>
